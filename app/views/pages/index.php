...
<div class="coverbgimg">
  <div class="covermiddle" style="padding:20px 30px 20px 30px;margin-top:10%; margin-left:auto; margin-right:auto;border-radius: 5px; min-width:280px; max-width:70%;background-color: green">
  <div>
    <h1>Project2</h1>
    <hr>
